...
<ul class="thumbnails">
	@foreach ($new_products as $newProducts)
		
  <li class="span3">
	<div class="thumbnail">
	  <a  href="product_details.html"><img src="{{ asset('upload/'.$value->image ) }}" alt=""/></a>
	  <div class="caption">
		<h5>{{ $newProducts->name }}</h5>
		<h4 style="text-align:center"><a class="btn" href="product_details.html"> <i class="icon-zoom-in"></i></a> <a class="btn" href="#">Add to <i class="icon-shopping-cart"></i></a> <a class="btn btn-primary" href="#">{{ $newProducts->price }}</a></h4>
	  </div>
	</div>
  </li>
  @endforeach
