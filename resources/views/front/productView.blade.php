...
<div class="span9">
	...
	<div class="row">	  
			...
			<div class="span6">
				  ...
				  <div class="control-group">
					...
					<div class="controls">
						<form method="POST" action="{{ route('cart.store') }}">
							@csrf
					<input type="number" class="span1" name="qnty" placeholder="Qty." required/>
				...
				<hr class="soft"/>
				<h4>{{ $product->Prodetail->total_item }}: items in stock</h4>
